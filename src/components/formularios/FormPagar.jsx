    ...
    return (
        <div className="formpagar">
            <form action="" className="">
                ...
                <input type="text" required className="formpagar__normal" id="nombre"/>
                <label htmlFor="nombre" className="formpagar__label">Nombre del Titular</label>
                <input type="text" required className="formpagar__normal" id="numero"/>
                <label htmlFor="numero" className="formpagar__label">Número de la Tarjeta</label>
                <input type="text" required className="formpagar__medio" id="fecha"/>
                <label htmlFor="fecha" className="formpagar__label">Fecha venc.</label>
                <input type="number" required className="formpagar__medio" id="cvv"/>
                <label htmlFor="cvv" className="formpagar__label--cvv">CVV</label>
                <input type="email" required className="formpagar__normal" id="correo"/>
